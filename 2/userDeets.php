...
while ($tuple = mysqli_fetch_row($result)) {
	print ' <div class="tweet">  UserId: '.$tuple[0] . ' </br> Username: ' .$tuple[1] . ' </br> Bio: ' .$tuple[2] . 
	' </br> <a href="followerList.php?user=' . $id . '">Followers: ' .$tuple[3] . 
	'</a> </br> <a href="followeeList.php?user=' . $id . '"> Follows: ' . $tuple[5] .
	'</a> </br> <a href="wbyList.php?id=' . $id . '"> Tweets published:' . $tuple[7] . '</a> 

<form method=get action="follow.php">
<button type="submit" value=' .$tuple[0] .' name="Follow">Follow</button>
</form>

<form method=get action="unfollow.php">
<button type="submit" value=' .$tuple[0] .' name="Unfollow">Unfollow</button>
</form>
